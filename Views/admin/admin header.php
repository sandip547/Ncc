        ...
        <div>
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="nav navbar-nav ml-auto">
              <li class="nav-item dropdown position-absolute mr-4" style="z-index: +1;">
                ...
                <ul class="nav dropdown-menu m-0 p-0 px-1 bg-light collapse drop" id="drops">
                  <li class="nav-item dropdown-item-for-nav w-100">
                    <a class="nav-link fontul" href="#" aria-selected="true">Dashboard</a>
                  </li>
                  <li class="nav-item dropdown-item-for-nav w-100">
                    <a class="nav-link fontul" href="product.php" aria-controls="profile" aria-selected="false">Product</a>
                  </li>
                  <li class="nav-item dropdown-item-for-nav w-100">
                    <a class="nav-link fontul" href="staff.php" aria-controls="enrolledcourses" aria-selected="false">Staff</a>
                  </li>
                  <li class="nav-item dropdown-item-for-nav w-100">
                    <a class="nav-link fontul" href="category.php" aria-controls="wishlist" aria-selected="false">Category</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-item"><a href="product.php" class="nav-link mx-1 text-light active">Welcome, User</a></li>
              ...
              <li class="nav-item"><a href="index.php" class="nav-link mx-1 text-light"><i class="bi bi-box-arrow-right"></i></a></li>
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="<?php if ($page == 'dashboard') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="product.php" aria-controls="dashboard" aria-selected="true"><i class="bi bi-speedometer2"> &nbsp; &nbsp;</i>Dashboard</a>
            </li>
            <li class="nav-item">
              <a class="<?php if ($page == 'product') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="product.php" aria-controls="product" aria-selected="true"><i class="bi bi-book-half"> &nbsp; &nbsp;</i>Product</a>
            </li>
            <li class="nav-item">
              <a class="<?php if ($page == 'student') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="student.php" role="tab" aria-controls="student" aria-selected="true"><i class="bi bi-mortarboard-fill"> &nbsp; &nbsp;</i>Student</a>
            </li>
            <li class="nav-item">
              <a class="<?php if ($page == 'staff') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="staff.php" role="tab" aria-controls="staff" aria-selected="true"><i class="bi bi-person-fill"> &nbsp; &nbsp;</i>Staff</a>
            </li>
            <li class="nav-item">
              <a class="<?php if ($page == 'category') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="category.php" aria-controls="Category" aria-selected="true"><i class="bi bi-grid-fill"> &nbsp; &nbsp;</i>Category</a>
            </li>
            <li class="nav-item">
              <a class="<?php if ($page == 'payment') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="payment.php" aria-controls="payment" aria-selected="true"><i class="bi bi-cash-coin"> &nbsp; &nbsp;</i>Payments</a>
            </li>
            <li class="nav-item">
              <a class="<?php if ($page == 'coursetopic') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="coursetopic.php" aria-controls="coursetopic" aria-selected="true"><i class="bi bi-card-heading"> &nbsp; &nbsp;</i>Course Topic</a>
            </li>
            <li class="nav-item">
              <a class="<?php if ($page == 'video') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="video.php" aria-controls="video" aria-selected="true"><i class="bi bi-camera-reels-fill"> &nbsp; &nbsp;</i>Video</a>
            </li>
            <li class="nav-item">
            <li class="nav-item">
              <a class="<?php if ($page == 'quiz') {
                          echo 'active';
                        } ?> nav-link custom-tab textsss" href="quiz.php" aria-controls="quiz" aria-selected="true"><i class="bi bi-question-diamond-fill"> &nbsp; &nbsp;</i>Quiz</a>
            </li>
            <li class="nav-item">
              <a class="nav-link custom-tab textsss" href="index.php" aria-selected="true"><i class="bi bi-box-arrow-right"> &nbsp; &nbsp;</i>Logout</a>
            </li>
          </ul>
        </div>
      </nav>
