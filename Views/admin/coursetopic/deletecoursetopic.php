...
<div class="table-responsive my-5">
    <table class="table table-bordered table-hover table-sm text-normal">
        ...
        <tbody>
            <tr>
                <th class="px-3"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#deletecoursetopicmodal">View</button></th>
                <th class="px-3">1</th>
...
<div class="modal fade" id="deletecoursetopicmodal" tabindex="-1" role="dialog" aria-labelledby="deletecoursetopicmodal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deletecoursetopicmodal">Course Topics</h5>
            ...
            <div class="modal-body">
                <div class="d-flex justify-content between col-md-12">
                    ...
                    <div class="col-md-10 text-right">
                        <p class="text-primary">1. this and that</p>
                    </div>
                </div>
                <div class="d-flex justify-content between col-md-12">
                    <div class="col-md-2">
                ...
                <div class="d-flex justify-content between col-md-12">
                    ...
                    <div class="col-md-10 text-right">
                        <p class="text-primary">2. this and that</p>
                    </div>
                </div>
                <div class="d-flex justify-content between col-md-12">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10 text-right">
                        <p class="text-primary">3. this and that</p>
                    </div>
                </div>
                <div class="d-flex justify-content between col-md-12">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10 text-right">
                        <p class="text-primary">4. this and that</p>
                    </div>
                </div>
                <div class="d-flex justify-content between col-md-12">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10 text-right">
                        <p class="text-primary">5. this and that</p>
                    </div>
                </div>
            </div>
