...
<div class="text-center">
    <button type="button" class="btn btn-primary fs-5 px-3 py-2 rounded-3" data-toggle="modal" data-target="#viewquizmodal">View Quiz</button>
</div>


<div class="modal fade" id="viewquizmodal" tabindex="-1" role="dialog" aria-labelledby="viewquizmodalTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewquizmodalTitle">Quiz title</h5>
