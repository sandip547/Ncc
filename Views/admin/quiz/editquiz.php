...
<div class="text-center">
    <button type="button" class="btn btn-primary fs-5 px-3 py-2 rounded-3" data-toggle="modal" data-target="#editquizmodal">Edit Quiz</button>
</div>


<div class="modal fade" id="editquizmodal" tabindex="-1" role="dialog" aria-labelledby="editquizmodalTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editquizmodalTitle">Quiz title</h5>
            ...
            <div class="modal-body">
                <div class="mb-4">
                    <div class="text-blue-shade fs-6 fw-bold d-flex my-2"><label class="col-sm-1 col-form-label">Q1. </label><input class="form-control col-md-11" type="text" value="What is this?"></div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="questionfirst" id="questionfirst1">
                        <input class="form-control" type="text" value="Apple">
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="questionfirst" id="questionfirst2">
                        <input class="form-control" type="text" id="questionfirstoption2" value="Mango">
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="questionfirst" id="questionfirst3">
                        <input class="form-control" type="text" value="Orange">
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="questionfirst" id="questionfirst4">
                        <input class="form-control" type="text" value="Strawberry">
                    </div>
                </div>
                <hr class="bg-primary my-5">
                <div class="my-4">
                    <div class="text-blue-shade fs-6 fw-bold d-flex my-2"><label class="col-sm-1 col-form-label">Q2. </label><input class="form-control col-md-11" type="text" value="What is this?"></div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="questionfirst" id="questionfirst1">
                        <input class="form-control" type="text" value="Apple">
                    </div>
                ...
                <div>
                    ...
                    <div class=" d-flex flex-wrap my-4">
                        <div class="col-md-8 text-orangered font-weight-bold fs-6">
