...
class RegController{
    ...
    function getChecker(){return $this->checker;}
    function getPasswordChecker(){return $this->check_password;}
   ...
   function updateUserDetails($studentuser){
        ...
        $result = $this->connection->executePrepare($query,"sssisssbi",array($fullname,$studentuser->getTsUser()->getDob(),$studentuser->getTsUser()->getEmail(),
                                                                                  $studentuser->getTsUser()->getGender(),$studentuser->getTsUser()->getUsername(),
   ...
   function deleteUserDetails($du){
    ...
    function insertTeacherDetails($staff){
        ...
        $result = $this->connection->executePrepare($query,"sssisssssssiss",array($fullname,$staff->getTsUser()->getDob(),$staff->getTsUser()->getEmail(),
                                                                                  ...
                                                                                  ,$staff->getTsUser()->getUsername(),$this->encrypt->encrypt($staff->getTsUser()->getPassword())));
        mysqli_close($this->connection->getConnection());
    }
    ...
    function updateTeacherDetails($staff){
        ...
        $result = $this->connection->executePrepare($query,"sssissssisisi",array($fullname,$staff->getTsUser()->getDob(),$staff->getTsUser()->getEmail(),
                                                                                      $staff->getTsUser()->getGender(),$staff->getTsUser()->getMob(),
